...
class Command extends Component
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            // 记录sql执行的时长
            $customMessage['duration'] = microtime(true) - $startTime;

            // 记录日志
            Yii::endProfile(json_encode($customMessage), __METHOD__);
    ...
    protected function queryInternal($method, $fetchMode = null)
    {
        ...
        try {
            ...
            // 记录日志
            Yii::endProfile(json_encode($customMessage), 'yii\db\Command::query');
        } catch (\Exception $e) {
            // 记录sql执行的时长
            $customMessage['duration'] = microtime(true) - $startTime;
